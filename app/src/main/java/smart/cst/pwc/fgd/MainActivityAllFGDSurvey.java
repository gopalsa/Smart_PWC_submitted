...
public class MainActivityAllFGDSurvey extends AppCompatActivity {
    ...
    private ArrayList<MainFGD> itemArrayList = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addMaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAllFGDSurvey.this, MainActivityFGD.class);
                    ...
                    if (!error) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            try {
                                ...
                                MainFGD mainFGD = new Gson().fromJson(dataObject.getString("data"), MainFGD.class);
