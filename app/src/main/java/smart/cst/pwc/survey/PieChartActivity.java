...
import smart.cst.pwc.survey.adapters.BaseStudentAdapter;
import smart.cst.pwc.survey.adapters.StudentAdapterByName;
...
public class PieChartActivity extends AppCompatActivity implements SurveyItemClick {
    ...
    static List<smart.cst.pwc.survey.adapters.Response> responses = new ArrayList<>();
    ...
    private void loadHomeFragment(String question, String surveyName) {
        ...
        for (int i = 0; i < surveyArrayList.size(); i++) {
            smart.cst.pwc.survey.adapters.Response response = new smart.cst.pwc.survey.adapters.Response();
...
//                    pie.print(PaperSize.A4, false);
            ...
            Comparator<smart.cst.pwc.survey.adapters.Response> movieComparator =
        ...
        @Override
        public void onItemClicked(smart.cst.pwc.survey.adapters.Response task) {
