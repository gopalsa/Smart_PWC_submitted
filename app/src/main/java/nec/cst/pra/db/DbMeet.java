...
public class DbMeet extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "meetManager";

    // Contacts table name
    private static final String TABLE_CONTACTS = "meet";
