...
import nec.cst.pra.action.academic.AcademicAdapter;
import nec.cst.pra.action.activitydetail.ActivityDetail;
import nec.cst.pra.action.activitydetail.ActivityDetailAdapter;
import nec.cst.pra.action.basevillage.Base;
import nec.cst.pra.action.basevillage.BaseVillageAdapter;
import nec.cst.pra.action.household.HouseHold;
import nec.cst.pra.action.household.HouseHoldAdapter;
import nec.cst.pra.action.major.Major;
import nec.cst.pra.action.major.MajorAdapter;
import nec.cst.pra.action.meeting.Meeting;
import nec.cst.pra.action.meeting.MeetingAdapter;
import nec.cst.pra.action.miscellaneous.Miscellaneous;
import nec.cst.pra.action.miscellaneous.MiscellaneousAdapter;
import nec.cst.pra.action.salient.Salient;
import nec.cst.pra.action.salient.SalientAdapter;
import nec.cst.pra.action.technologies.Technologies;
import nec.cst.pra.action.technologies.TechnologiesAdapter;
import nec.cst.pra.action.technologyCustomisation.TechnologyCustomisation;
import nec.cst.pra.action.technologyCustomisation.TechnologyCustomisationAdapter;
import nec.cst.pra.action.technologyDevelopment.TechnologyDevelopment;
import nec.cst.pra.action.technologyDevelopment.TechnologyDevelopmentAdapter;
import nec.cst.pra.action.uba.Uba;
import nec.cst.pra.action.uba.UbaAdapter;
import nec.cst.pra.action.vdp.Vdp;
import nec.cst.pra.action.vdp.VdpAdapter;
import nec.cst.pra.action.village.Village;
import nec.cst.pra.action.village.VillageAdapter;
import nec.cst.pra.action.villageDevelopment.VillageDevelopment;
import nec.cst.pra.action.villageDevelopment.VillageDevelopmentAdapter;
import nec.cst.pra.action.workingGroup.WorkingGroupAdapter;
import nec.cst.pra.action.workingGroup.Workinggroup;
